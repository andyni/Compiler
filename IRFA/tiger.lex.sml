...
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; stringTokenContent:=""; stringStartPosition:=yypos; continue()))
fun yyAction45 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; Tokens.STRING(!stringTokenContent, !stringStartPosition, yypos+size(!stringTokenContent))))
...
fun yyAction50 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Illegal character in format region: " ^ yytext); continue())
      end
...
fun yyAction52 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringTokenContent := !stringTokenContent ^ "\t"; continue()))
fun yyAction53 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (let val ascii = Option.valOf(Int.fromString (String.substring (yytext, 1, size(yytext)-1))) 
			    in 
				if (ascii < 128) 
...
fun yyAction57 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (stringTokenContent := !stringTokenContent ^ yytext; continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction6(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction6(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ64(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction2(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction2(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction5(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction5(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction3(strm, yyNO_MATCH)
                      else yyQ64(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction3(strm, yyNO_MATCH)
                  else yyQ64(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ64(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ106(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ43 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction23(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ110(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ41 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ111(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
...
fun yyQ26 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #" "
              then yyQ26(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #" "
              then if inp = #"\t"
                  then yyQ26(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\\"
              then yyQ10(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp < #"\\"
              then if inp = #"#"
